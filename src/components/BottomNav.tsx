...
export default function BottomNav(){
  ...
  return(
        <div className=" bg-[#201f24] border-t border-gray-100 rounded-t-2xl pt-2 px-2  lg:border-none lg:rounded-tl-none lg:h-full ">
